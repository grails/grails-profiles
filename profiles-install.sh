...
cp /home/travis/build/grails-profiles-tests/rest-api-plugin/build/grails-wrapper/wrapper/build/libs/grails4-wrapper-2.0.1.BUILD-SNAPSHOT.jar $HOME/.grails/wrapper/grails4-wrapper.jar
